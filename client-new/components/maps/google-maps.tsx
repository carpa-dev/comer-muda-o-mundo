...
export function useMarkers(
  ...
  const [markersRef, setMarkersRef] = useState<google.maps.Marker[]|undefined>(undefined);
  ...
  useEffect(() => {  
    ...
    // TODO: marker images
    const markers = markerOptions.map((options) =>
...
export function useMarkerCluster(
  ...
  const [markersRef, setMarkersRef] = useState<google.maps.Marker[]|undefined>(undefined);
  const [markerClusterRef, setMarkerClusterRef] = useState<MarkerClusterer|undefined>(undefined);
  ...
  useEffect(() => {  
    ...
    const markerCluster = new api.MarkerClusterer(
      interactiveMap.map,
      markers,
      {
        // TODO: cluster images
